...
<script type="text/javascript">
	$(function() {
		...
		$("#LikBasket").click(function(){
			...
			// 1.获取商品id
			var goodsInfoId = "${param.id}"; // req.getParremet("id");
			
			// 2.获取商品的数量
			var num = $("#value").val();
			
			// 3.异步发送请求把商品添加购物车
			$.get("ShopServlet/addShopCar?id="+goodsInfoId+"&num="+num,"",function(){
				// 这个回调函数请求响应成功后调用
